        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationRecipient_Rules_NotificationRuleId",
                        column: x => x.NotificationRuleId,
                        principalTable: "Rules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_NotificationRecipient_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifiers_Rules_NotificationRuleId",
                        column: x => x.NotificationRuleId,
                        principalTable: "Rules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationRecipient_NotificationRuleId",
                table: "NotificationRecipient",
                column: "NotificationRuleId");

            migrationBuilder.CreateIndex(
                name: "IX_NotificationRecipient_RoleId",
                table: "NotificationRecipient",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifiers_NotificationRuleId",
                table: "Notifiers",
                column: "NotificationRuleId");
