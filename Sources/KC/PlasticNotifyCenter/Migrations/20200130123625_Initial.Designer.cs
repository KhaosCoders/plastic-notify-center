...
namespace PlasticNotifyCenter.Migrations
{
    ...
    [Migration("20200130123625_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlasticNotifyCenter.Data.AppSettings", b =>
                {
                    ...
                    b.Property<string>("HtmlMessageTemplate")
                        .HasColumnType("TEXT");

                    b.Property<int?>("LdapConfigId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PlasticNotifyCenter.Data.LdapSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("LdapGroupGuidAttr")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("LdapUserGuidAttr")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PlasticNotifyCenter.Data.NotificationRule", b =>
                {
                    ...
                    b.Property<int>("NotificationBodyType")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("UseGlobalMessageTemplate")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PlasticNotifyCenter.Data.RuleNotifier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("PlasticNotifyCenter.Data.AppSettings", b =>
                {
                    b.HasOne("PlasticNotifyCenter.Data.LdapSettings", "LdapConfig")
                        .WithMany()
                        .HasForeignKey("LdapConfigId");
                });
            ...
            modelBuilder.Entity("PlasticNotifyCenter.Data.RuleNotifier", b =>
                {
                    b.HasOne("PlasticNotifyCenter.Data.BaseNotifierData", "Notifier")
                        .WithMany("Rules")
                        .HasForeignKey("NotifierId");

                    b.HasOne("PlasticNotifyCenter.Data.NotificationRule", "Rule")
                        .WithMany("Notifiers")
